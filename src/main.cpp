#include <Arduino.h>
/*
переход с стартовой страницы 00 на рабочую страницу отправляем в дисплей команду
5A A5 07 82 00 84 5A 01 00 01, где 01- это следующая страница. так как у нас стартовая страница 00, следующая страница 01

/*
Иконки и их адреса в DWIN:
Буровой насос - 1003, его замочек 1007
Шаровый кран - 1004, его замочек 1008
Манипулятор - 1005
Нижний захват - 1006
Скоростиметр - 1001
Высотометр - 1002
...
Разблокировка Тормоз лебёдки - 2001 (это поле c diginal indicator) при каждом нажатии +10сек к разблокировке максимум 60с
Резет высоты - 2002
сброс alarm - 2003
